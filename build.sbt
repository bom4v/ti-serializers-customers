//
// File: https://github.com/bom4v/ti-serializers-customers/blob/master/build.sbt
//
...
homepage := Some(url("https://github.com/bom4v/ti-serializers-customers"))
startYear := Some(2019)
description := "Serializers (input and output) for the customer-related models"
licenses += "Apache-2.0" -> url("https://www.apache.org/licenses/LICENSE-2.0")

scmInfo := Some(
  ScmInfo(
    url("https://github.com/bom4v/ti-serializers-customers"),
    "https://github.com/bom4v/ti-serializers-customers.git"
  )
)
